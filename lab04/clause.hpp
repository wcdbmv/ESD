...
public:
	...
	/// Приведение дизъюнкта к виду, где атомы не повторяются, или к истине, если внутри него есть пара типа: ~A, A.
	///
	/// @returns дизъюнкт с неповторяющимися атомами или пустой дизъюнкт в случае истины.
